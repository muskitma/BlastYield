...
#[derive(Debug)]
pub struct BlastYieldProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlastYieldProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlastYield processing");
    
    let mut processor = BlastYieldProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlastYieldProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlastYieldProcessor::new(false);
